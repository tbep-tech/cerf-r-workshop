...
1. Feel free to ask questions during the training. We will also use the stickies to signal 
...
Please view the [Data and Resources](Data_and_Resources.html) page for data used in this workshop and additional links for R learning material.  A [live coding](https://tinyurl.com/cerf-r-training-live-coding){target="_blank"} link is also available.
